...
class Config:
    ...
    # ------------------------------------------------------------------------------------------------------------------
    # Zmienne srodowiskowe od bazy danych
    # ------------------------------------------------------------------------------------------------------------------
    ...
    def configure_logging(app: Flask) -> None:
        # Kiedy masz dictConfig za kazdym razem gdy wywolasz configure_logging dodajesz
        # handlery. Jesli np. create_app bedzie uruchamiany wielokrotnie, to bedziesz mial
        # duplikaty logow (kazdy log wypluwany kilka razy). Zeby tego uniknac w configure_logging
        # dodajemy flage, ktora sygnalizuje ze logging juz zostal skonfigurowany.
        ...
        logger_level = 'DEBUG' if bool(app.config['FLASK_DEBUG']) else 'INFO'
        dictConfig({
            'version': 1,
            'formatters': {
                'default': {
